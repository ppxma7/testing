...
myGames = {'Nintendo Switch', 'Switch accessories','Pokemon Shield', 'Luigis Mansion 3',...
    ...
    'TLOU2','Nintendo other','Gamepass','Nintendo other','Control dlc','Nintendo other','Vanquish/Bayo',...
    'Nintendo other','PSplus','Nintendo topup','Below','Manifold Garden','Resident Evil 2','PSPlus','THPS',...
    'Spiritfarer','FFVII Remake','FFVII','FFVIII','FFIX','FFX11','Switcher',...
    'PS5','Miles Morales','AC Valhalla'}';

console = {'Nintendo','Nintendo','Nintendo','Nintendo',...
    'Nintendo','Nintendo',...
    'Nintendo','Nintendo','Nintendo','Nintendo','PS4',...
    'Nintendo',...
    'PS4','Xbox','Nintendo','Nintendo','Nintendo','Xbox','Xbox','Xbox',...
    'Xbox','Xbox','Xbox',...
    'PS4','Nintendo','Xbox','Nintendo','PS4','Nintendo','PS4',...
    'Nintendo','PS4','Nintendo','PS4','PS4','PS4','PS4','PS4',...
    'Nintendo','PS4','Nintendo','Nintendo','Nintendo','Nintendo','Nintendo',...
    'PS5','PS5','PS5'}';
...
myCost = [199.99 76 44.99 44.99 19.99 7.99 17.99 10.34 12.99,...
    12.99 25 16.99 7.99 7.99 15.49 33.49 23 7.99 14.39 59.99,...
    38.99 7.99 28 54.99 14 10.99 26.67 16 16.65 19.99 16.15 6.99,...
    50 29.48 13.49 22.49 37.49 36.99 21 32.99 7 7 7 20 35,...
    449.99 49.99 48]';
